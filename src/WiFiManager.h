...
public:
    ...
    bool autoConnect();
    void setContentText(String& title, String& name, String& maker, String& version);
    void setContentMainImage(const char* img);

    inline static const char *HOSTNAME = "nightlight";    // hostname for mDNS to enable http://picow.local
